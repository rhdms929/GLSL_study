...
void Renderer::CreateVertexBufferObjects()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(particleVerts),
		particleVerts, GL_STATIC_DRAW); //업로드
}
...
void Renderer::CreatParticleCloud(int numParticles)
{
...
void Renderer::DrawParticle()
{
	...
	m_ParticleTime += 0.00016; //정확하진 않다.
